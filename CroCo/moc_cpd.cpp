...
#include "../CroCo_git/croco/croco/cpd.h"
...
const QMetaObject CPD::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_CPD.data,
      qt_meta_data_CPD,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *CPD::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CPD.stringdata0))
        return static_cast<void*>(const_cast< CPD*>(this));
