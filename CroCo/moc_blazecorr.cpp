...
QT_MOC_LITERAL(11, 184, 23) // "on_pushButton_3_clicked"
...
void BlazeCorr::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<BlazeCorr *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject BlazeCorr::staticMetaObject = { {
    QMetaObject::SuperData::link<QDialog::staticMetaObject>(),
    qt_meta_stringdata_BlazeCorr.data,
    qt_meta_data_BlazeCorr,
    qt_static_metacall,
    nullptr,
    nullptr
} };
