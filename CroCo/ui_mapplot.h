...
public:
    ...
    {
        MapPlot->setWindowTitle(QApplication::translate("MapPlot", "Dialog", 0));
        label->setText(QApplication::translate("MapPlot", "File", 0));
        label_2->setText(QApplication::translate("MapPlot", "from", 0));
        label_3->setText(QApplication::translate("MapPlot", "to", 0));
        pushButton_2->setText(QApplication::translate("MapPlot", "Show", 0));
        label_4->setText(QApplication::translate("MapPlot", "Work Path:", 0));
        pushButton_3->setText(QApplication::translate("MapPlot", "Save As", 0));
        checkBox->setText(QApplication::translate("MapPlot", "pdf", 0));
        checkBox_2->setText(QApplication::translate("MapPlot", "png", 0));
        label_5->setText(QApplication::translate("MapPlot", "Font Size:", 0));
        pushButton->setText(QApplication::translate("MapPlot", "Close", 0));
    } // retranslateUi
