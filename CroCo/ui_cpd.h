...
public:
    ...
    void setupUi(QDialog *CPD)
    {
        if (CPD->objectName().isEmpty())
            CPD->setObjectName(QStringLiteral("CPD"));
        CPD->resize(1055, 274);
        ...
        doubleSpinBox_13->setMaximum(9.99);
        ...
        doubleSpinBox_15->setMaximum(9.99);
    ...
    {
        CPD->setWindowTitle(QApplication::translate("CPD", "Dialog", 0));
        label->setText(QApplication::translate("CPD", "Files:", 0));
        label_2->setText(QApplication::translate("CPD", "from", 0));
        label_3->setText(QApplication::translate("CPD", "to", 0));
        label_4->setText(QApplication::translate("CPD", "*", 0));
        label_27->setText(QApplication::translate("CPD", "RV-File", 0));
        label_12->setText(QApplication::translate("CPD", "Primary", 0));
        checkBox->setText(QApplication::translate("CPD", "Window 1 from", 0));
        label_6->setText(QApplication::translate("CPD", "to", 0));
        label_20->setText(QApplication::translate("CPD", "Value", 0));
        checkBox_2->setText(QApplication::translate("CPD", "Window 2 from", 0));
        label_8->setText(QApplication::translate("CPD", "to", 0));
        label_21->setText(QApplication::translate("CPD", "Value", 0));
        checkBox_3->setText(QApplication::translate("CPD", "Window 3 from", 0));
        label_10->setText(QApplication::translate("CPD", "to", 0));
        label_22->setText(QApplication::translate("CPD", "Value", 0));
        label_13->setText(QApplication::translate("CPD", "Secondary", 0));
        label_14->setText(QApplication::translate("CPD", "from", 0));
        label_17->setText(QApplication::translate("CPD", "to", 0));
        label_23->setText(QApplication::translate("CPD", "Value", 0));
        label_15->setText(QApplication::translate("CPD", "from", 0));
        label_18->setText(QApplication::translate("CPD", "to", 0));
        label_24->setText(QApplication::translate("CPD", "Value", 0));
        label_16->setText(QApplication::translate("CPD", "from", 0));
        label_19->setText(QApplication::translate("CPD", "to", 0));
        label_25->setText(QApplication::translate("CPD", "Value", 0));
        label_26->setText(QApplication::translate("CPD", "Output", 0));
        label_5->setText(QApplication::translate("CPD", "Work Path", 0));
        pushButton_2->setText(QApplication::translate("CPD", "Go", 0));
        pushButton->setText(QApplication::translate("CPD", "Close", 0));
    } // retranslateUi
