...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        QIcon icon;
        icon.addFile(QStringLiteral(":/new/background/logo.png"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        QIcon icon3;
        icon3.addFile(QStringLiteral(":/new/background/New.png"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        QIcon icon4;
        icon4.addFile(QStringLiteral(":/new/prefix1/SPlotter.png"), QSize(), QIcon::Normal, QIcon::Off);
        actionPlot->setIcon(icon4);
        actionSequence_Plotter = new QAction(MainWindow);
        actionSequence_Plotter->setObjectName(QStringLiteral("actionSequence_Plotter"));
        QIcon icon5;
        icon5.addFile(QStringLiteral(":/new/prefix1/Sequ.png"), QSize(), QIcon::Normal, QIcon::Off);
        actionSequence_Plotter->setIcon(icon5);
        actionSave_As = new QAction(MainWindow);
        actionSave_As->setObjectName(QStringLiteral("actionSave_As"));
        actionRV_Curve = new QAction(MainWindow);
        actionRV_Curve->setObjectName(QStringLiteral("actionRV_Curve"));
        QIcon icon6;
        icon6.addFile(QStringLiteral(":/new/prefix1/RVCurve.png"), QSize(), QIcon::Normal, QIcon::Off);
        actionRV_Curve->setIcon(icon6);
        actionTemplate_Generator = new QAction(MainWindow);
        actionTemplate_Generator->setObjectName(QStringLiteral("actionTemplate_Generator"));
        QIcon icon7;
        icon7.addFile(QStringLiteral(":/new/prefix1/Template.png"), QSize(), QIcon::Normal, QIcon::Off);
        actionTemplate_Generator->setIcon(icon7);
        actionBinary_Tool = new QAction(MainWindow);
        actionBinary_Tool->setObjectName(QStringLiteral("actionBinary_Tool"));
        QIcon icon8;
        icon8.addFile(QStringLiteral(":/new/prefix1/Binary.png"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        actionRaname_Files->setObjectName(QStringLiteral("actionRaname_Files"));
        ...
        QIcon icon11;
        icon11.addFile(QStringLiteral("../../../../../../../home/daniels/work1/Disentangling/Template_Method/Log/Qt_LogCC/Data/run.png"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        customPlot->setMinimumSize(QSize(600, 0));
        ...
        sizePolicy7.setHeightForWidth(customPlot_2->sizePolicy().hasHeightForWidth());
        customPlot_2->setSizePolicy(sizePolicy7);
