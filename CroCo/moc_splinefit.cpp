...
QT_MOC_LITERAL(5, 77, 16), // "showPointToolTip"
QT_MOC_LITERAL(6, 94, 12), // "QMouseEvent*"
QT_MOC_LITERAL(7, 107, 5), // "event"
QT_MOC_LITERAL(8, 113, 11), // "writeCoords"
QT_MOC_LITERAL(9, 125, 23) // "on_pushButton_3_clicked"

    },
    "SplineFit\0on_pushButton_clicked\0\0"
    "on_pushButton_2_clicked\0on_checkBox_clicked\0"
    "showPointToolTip\0QMouseEvent*\0event\0"
    "writeCoords\0on_pushButton_3_clicked"
};
...
void SplineFit::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 3: _t->showPointToolTip((*reinterpret_cast< QMouseEvent*(*)>(_a[1]))); break;
        case 4: _t->writeCoords((*reinterpret_cast< QMouseEvent*(*)>(_a[1]))); break;
