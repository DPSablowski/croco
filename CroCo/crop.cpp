    ...
    ui(new Ui::Crop)
{
    ...
    ui->lineEdit->setText("cair_");
    ui->lineEdit_2->setText(".fits");
    ui->lineEdit_3->setText("Arg");
    ui->lineEdit_4->setText("DataVector");
    ui->lineEdit_5->setText("Fun");
    ui->lineEdit_7->setText("/home/daniels/Observations/EcB/pxhya/Ca_IR/Reduced");

    ui->doubleSpinBox->setValue(3.92888);
    ui->doubleSpinBox_2->setValue(3.93802);
